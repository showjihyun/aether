...
| 4. Implementation | 코드 | `apps/`, `packages/` | `./harness/scripts/verify.sh` | **다음 단계입니다.** H-1(사람: 보호 파일 다섯 개, plan 부록 A~E) → P0-1(`implementer`). 코드는 아직 없습니다 |
...
| --- | --- | --- | --- | --- |
| [0001](0001-phase-0-foundation.md) | Phase 0 — Architecture & Foundation | [Phase 0](../docs/roadmap.md) | 승인됨 | [0001](../specs/0001-phase-0-foundation.md) 승인됨 |
