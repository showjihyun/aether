...
| 키 | 값 |
| --- | --- |
| 활성 intent | [0003 — Phase 2: Enterprise MCP Gateway](0003-phase-2-mcp-gateway.md) — 승인됨 2026-09-25. 직전 [0002](0002-phase-1-agent-runtime.md) 는 완료(2026-09-16) |
| 상태 | 승인됨 — intent·spec(D-1 ~ D-16, 개정 1)·plan 전부 2026-09-25 승인. **구현 착수 가능**하고 첫 단위는 plan 1절의 P2-1 입니다 |
| 승인 | showjihyun, 2026-09-25 (0002 는 showjihyun, 2026-09-12) |
| 후속 spec | [../specs/0003-phase-2-mcp-gateway.md](../specs/0003-phase-2-mcp-gateway.md) (승인됨 2026-09-25, D-1 ~ D-16 · 개정 1). 0002 의 것은 [../specs/0002-phase-1-agent-runtime.md](../specs/0002-phase-1-agent-runtime.md) (승인됨 2026-09-12) |
| 열린 질문 | 0003 의 6건 전부 닫힘 — spec 0003 의 D-1 ~ D-6 이 답입니다(공식 SDK `mcp` 2.2.0 · 바인딩은 definition·감사는 `data` · 이번엔 기록만 · `smoke` 는 Filesystem 하나 · 내부 도구 둘은 MCP Server 로 이전 · 판정은 호출마다). 외부 사실 확인에서 D-7·D-8 이 더해졌습니다. 0002 의 8건도 닫힘(D-1 ~ D-19) |
| 갱신일 | 2026-09-25 |
...
| --- | --- | --- | --- | --- |
| 1. Intent | 무엇을 왜 (proto-spec) | `intents/<NNNN>-<슬러그>.md` — 활성 건은 이 파일이 가리킵니다 | 사람 | 0003 승인됨 2026-09-25. 0002 완료 2026-09-16. 0001 완료 |
| 2. Spec | 요구사항과 설계 | `specs/<같은 슬러그>.md` | 사람 | 0003 승인됨 2026-09-25 (D-1 ~ D-13). 0002 승인됨 2026-09-12 (D-1 ~ D-19). 0001 승인됨 2026-09-09 |
| 3. Plan | 어느 파일을 어떻게 (Plan Mode) | `plans/<같은 슬러그>.md` | 사람 | 0003 승인됨 2026-09-25([../plans/0003-phase-2-mcp-gateway.md](../plans/0003-phase-2-mcp-gateway.md), 7 단위·3 접촉, 리뷰 F-1 ~ F-7 반영). 0002 승인됨 2026-09-12. 0001 승인됨 2026-09-09 |
| 4. Implementation | 코드 | `apps/`, `packages/` | `./harness/scripts/verify.sh` | **완료.** 0002 의 11 단위가 전부 `verify.sh` 17단계 통과 + PR 병합(마지막 PR #29, 2026-09-16). 0001 도 완료(2026-09-11). **Phase 2 는 착수 가능**(intent·spec·plan 승인 2026-09-25). 첫 단위 P2-1 |
...
| [0003](0003-phase-2-mcp-gateway.md) | Phase 2 — Enterprise MCP Gateway | [Phase 2](../docs/roadmap.md) | 승인됨 (2026-09-25) | [0003](../specs/0003-phase-2-mcp-gateway.md) 승인됨 |
...
| Phase 완료 판정(spec 의 R 전부)이 통과했다 | intent 의 `상태` 를 `완료` 로. `활성 intent` 를 다음 건으로 옮기고 `목록` 의 상태를 바꿉니다 |
| intent 가 폐기됐다 | `상태` 를 `폐기` 로. 파일은 지우지 않습니다 |
