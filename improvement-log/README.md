...
**AD-2(Week 1)에 진입했습니다.** 2026-09-11, P0-7 에서 candidate 15건을 발급했습니다(`2026-09-11-001` ~ `015`. 014·015 는 후보 파일 검토와 H-2b 의 CI 실패에서 관측). P0-9 에서 3건(`016` 거짓 red · `017` PEP 563 + `Depends` 422 · `018` 검토 대기 red 와 stop 게이트). 전부 `status: candidate`, `trust: untrusted` 이며 `promoted` 는 아직 0건입니다.
