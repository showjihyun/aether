...
spec 0002 의 R 전부가 어느 단위에서 판정되는지입니다. **2026-09-16 기준 R-1 ~ R-16 전부 판정 통과**(마지막 PR #29). 실측: 로컬 verify 17단계 163.4초(smoke 39.7초), CI `verify` job 약 3분, Run 생성 응답 p95 36.8 ms(기준 150 ms).
